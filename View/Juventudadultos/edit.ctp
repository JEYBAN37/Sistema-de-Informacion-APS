...
<?php echo $this->Form->create('Juventudadulto'); ?>
	<fieldset>
		<legend><?php echo __('Edit Juventudadulto'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Juventudadulto.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Juventudadulto.id'))); ?></li>
