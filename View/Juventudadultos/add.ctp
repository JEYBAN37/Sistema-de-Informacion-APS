	...
	<div class="bg-white shadow-2xl rounded-xl  p-6  md:p-12">
		...
		<div class="grid grid-cols-1 md:grid-cols-3">
			...
			<div class="w-full p-2">
				<button name="btn" value="Guardar y agregar integrante" type="submit" class="w-full bg-teal-600 text-white px-6 py-2 rounded-md hover:bg-green-700 transition font-medium flex items-center justify-center gap-2">
					<span>
