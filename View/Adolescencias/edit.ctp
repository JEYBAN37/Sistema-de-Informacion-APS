...
<?php echo $this->Form->create('Adolescencia'); ?>
	<fieldset>
		<legend><?php echo __('Edit Adolescencia'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Adolescencia.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Adolescencia.id'))); ?></li>
