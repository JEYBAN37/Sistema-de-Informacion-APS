                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover"
                                ...
                                <tbody>
                                    <?php foreach ($infantils as $infantil) : ?>
                                        <tr class="gradeA odd">
                                            <td class="sorting_1">
                                                <?php echo h($infantil['Infantil']['id']); ?>&nbsp;</td>

                                            <td><?php echo h($infantil['Familia']['id']); ?>&nbsp;</td>
                                            <td>
                                            ...
                                            <td><?php echo h($infantil['Infantil']['observacioncanalizacion']); ?>&nbsp;
                                            </td>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li><?php echo $this->Html->link(('Ver registro'),
                                                                array('action' => 'view', $infantil['Infantil']['id']),
                                                                array(
                                                        ...
                                                        <li><?php echo $this->Html->link(('Editar'),
                                                                array('action' => 'edit',   $infantil['Infantil']['id']),
                                                                array(
                                                                    'onclick' => "return confirm('¿Estás seguro que deseas editar la información del menor " .   $infantil['Infantil']['primernombre'] . " " .   $infantil['Infantil']['primerapellido'] . "?');",
                                                                    'style' => 'font-size: 14px;'
                                                                )
                                                            ); ?>
                                                        </li>
                                                        <li><?php echo $this->Html->link(('Obsevacion canalización'),
                                                                array('action' => 'edit1',   $infantil['Infantil']['id']),
                                                                array(
                                                                    'onclick' => "return confirm('¿Estás seguro de agregar una observacion del menor " .   $infantil['Infantil']['primernombre'] . " " .   $infantil['Infantil']['primerapellido'] . "?');",
                                                                    'style' => 'font-size: 14px;'
                                                                )
                                                            ); ?>
                                                        </li>
