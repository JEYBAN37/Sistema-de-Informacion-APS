<div class="reportes index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('primerainfancia_id'); ?></th>
			<th><?php echo $this->Paginator->sort('infantil_id'); ?></th>
			<th><?php echo $this->Paginator->sort('adolescencia_id'); ?></th>
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $reporte['Reporte']['id']), array(), __('Are you sure you want to delete # %s?', $reporte['Reporte']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
