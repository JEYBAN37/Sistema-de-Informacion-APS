        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="col-span-2 md:col-span-1 text-md font-semibold my-6 mr-4">
                ...
                <div class="flex items-center mb-4">
                    ...
                    <label for="proactividad_id" class="font-semibold">Seleccionar riesgos en salud</label>
                ...
                $menorriesgosalud = array(
                    '' => 'Elegir',
                                '0' => 'No',
                                '12' =>'Menor con Riesgo desnutrición',
                                '8' => 'Menor sin esquema de vacunación completo',                                
                                '8' => 'Menor con Signos de peligro EDA o IRA', 
                                '3' => 'Menor sin valoraciones de PYM',
                                '3' => 'Persona joven/adulto sin valoraciones de PYM',                               
                                '12' =>'Gestante sin control',
                                '12' => 'Embarazo de alto riesgo',
                                '-' => 'Persona con enfermedad crónica',
                                '8' => 'Persona con enfermedad crónica sin control',
                                '3' => 'Persona Sintomatico respiratorio o de piel',
          ...
          <div class="col-span-2 md:col-span-1 text-md font-semibold my-6 mr-4">
            ...
            <div class="col-span-2 md:col-span-1 text-md font-semibold my-6 mr-4">
                <div class="flex items-center mb-4">
                    ...
                    <label for="proactividad_id" class="font-semibold">Adolescente con algún riesgo en salud</label>
                    <p class="text-red-600">*</p>
                </div>
           ...
           <div class="col-span-2 md:col-span-1 text-md font-semibold my-6 mr-4">
                <div class="flex items-center mb-4">
                    ...
                    <label for="proactividad_id" class="font-semibold">Joven o adulto con algún riesgo en salud</label>
                    <p class="text-red-600">*</p>
                </div>
            ...
            <div class="col-span-2 md:col-span-1 text-md font-semibold my-6 mr-4">
                ...
                <?php
                      $riesgovulnerabilidad = [
                                ...
                                '2.1' => 'Persona sin afiliación a salud',
                                '2.2' => 'Persona con consumo SPA',
                                '2.3' => 'Sospecha de violencia intrafamiliar',
                                '2.4' => 'Vivienda precaria',
                                '2.5' => 'Persona no afiliada a salud',
                                '1.0' => 'Cuidador con sobrecarga',                                
                                '1.1' => 'Disfunción famliliar',
                                '1.1' => 'Relaciones familiares tensas o estresantes',
                            ];
