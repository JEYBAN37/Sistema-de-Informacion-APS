...
<div class="max-w-5xl mx-auto text-center mb-8">
    ...
    <p class="text-gray-500 mb-4 text-lg">
        Registre los datos la nueva vivienda.
    </p>
</div>
    ...
    <div class="bg-white shadow-2xl rounded-xl p-12">
        ...
        <div class="flex items-center mb-4">
            ...
            <div class="ml-4">
                ...
                <p class="text-gray-500">Complete los datos generales del acta.</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="col-span-2 md:col-span-1 text-md font-semibold my-6 mr-4">
                <div class="flex items-center mb-4">
                    ...
                    <label for="proactividad_id" class="font-semibold">Microterritorio</label>
                    <p class="text-red-600">*</p>
                ...
                echo $this->Form->input('ubicacion_id', [
                    ...
                    'error' => false,
                    'label' => '',
                    'empty' => 'Seleccione Microterritorio'
                ]);
            ...
            <div class="col-span-2 text-md font-semibold my-6">
                <div class="flex items-center mb-4">
                    ...
                    <label for="direccion" class="font-semibold">Barrio/corregimiento/sector/vereda</label>
                </div>
                ...
                echo $this->Form->input('barriovereda', [
                    ...
                    'id' => 'direccion',
                    'class' => 'border border-gray-300 rounded-lg w-full p-2 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 text-sm text-gray-700',
                    'empty' => 'Registre el barrio, corregimiento, sector o vereda',
                    'error' => false // No mostrar error aquí
                ]);
                ?>
                <?php
                if (!empty($this->Form->error('barriovereda'))) {
                    echo '<div class="text-red-600 text-md mt-1 font-semibold">' . $this->Form->error('dierccion') . '</div>';
                }
                ?>
            </div>
            ...
            <div class="col-span-2 text-md font-semibold my-6">
                ...
                <?php
                echo $this->Form->input('dierccion', [
                    'label' => false,
                    'type' => 'text',
                    'id' => 'direccion',
                    'class' => 'border border-gray-300 rounded-lg w-full p-2 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 text-sm text-gray-700',
                ...
                ?>
                <?php
                if (!empty($this->Form->error('dierccion'))) {
                    echo '<div class="text-red-600 text-md mt-1 font-semibold">' . $this->Form->error('dierccion') . '</div>';
                }
                ?>
            </div>
            ...
            <div class="col-span-2 text-md font-semibold my-6">
                <div class="flex items-center mb-4">
                    <span class="mr-2 px-2 rounded-lg bg-green-200 text-md font-semibold">4</span>
                    <label for="latitud" class="font-semibold">Geopunto latitud</label>
                </div>
            ...
            <div class="col-span-2 text-md font-semibold my-6">
                <div class="flex items-center mb-4">
                    <span class="mr-2 px-2 rounded-lg bg-green-200 text-md font-semibold">4</span>
                    <label for="longitud" class="font-semibold">Geopunto latitud</label>
                </div>
            ...
            <div class="col-span-2 text-md font-semibold my-6">
                <div class="flex items-center mb-4">
                    <span class="mr-2 px-2 rounded-lg bg-green-200 text-md font-semibold">4</span>
                    <label for="apellidosfamilia" class="font-semibold">Apellidos Familia</label>
                </div>
                ...
                echo $this->Form->input('apellidosfamilia', [
                    ...
                    'id' => 'apellidosfamilia',
                    'class' => 'border border-gray-300 rounded-lg w-full p-2 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 text-sm text-gray-700',
                    'empty' => 'Registre apellidos de la familia',
                    'error' => false // No mostrar error aquí
                ]);
                ?>
                <?php
