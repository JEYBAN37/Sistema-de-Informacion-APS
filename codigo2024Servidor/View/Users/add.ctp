...
<?php echo $this->Form->create('User'); ?>
    ...
    <fieldset>
      ...
      <div class="row">
        ...
        <?php echo $this->Form->input('nombre', array('label'=>'Nombres y apellidos')); ?>
            </div>  
        ...
        <div class="form-group col-md-6">
        <?php echo $this->Form->input('nivel', array('label'=>'Tipo de usuario', 'type'=>'select','options'  => array('' => 'Elegir','D'=>'Integrante APS' ))); ?>
            </div> 
