...
$serv = 'localhost';
$port = '';
$userS = 'agsolutic_fichafamilarbdresolucionnueva';
$passS = 'FichaFamiliar2023*';
$bd = 'agsolutic_fichafamiliar2024';
?>
                            ...
                            <table width="100%" class="table table-responsive table-striped table-bordered  "
                                ...
                                <tr>
                                    ...
                                    <td><strong>Ubicación:</strong>
                                        <?php
                                        echo ($familia['Sociambiental']['ubicacion_id']); ?>
                                    </td>
