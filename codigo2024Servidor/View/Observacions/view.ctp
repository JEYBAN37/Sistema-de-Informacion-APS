                                ...
                                <div class="col-sm-12">
                                    ...
                                    <table width="100%" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" class="title">link: <?php echo $this->Html->link('../files/observacion/familiograma/' . $observacion['Observacion']['dirfamiliograma'] . '/' . $observacion['Observacion']['familiograma']); ?></td>
                                            <td colspan="4">
                                           ...
                                           <tr>
                                            <td colspan="2" class="title">Plan de cuidado</td>
                                            <td colspan="4">
                                                <?php echo ($observacion['Observacion']['plancuidado']); ?>
                                            </td>
                                            <td colspan="2" class="title">link: <?php echo $this->Html->link('../files/observacion/plancuidado/' . $observacion['Observacion']['dirplancuidado'] . '/' . $observacion['Observacion']['plancuidado']); ?></td>
                                            <td colspan="4">
                                                <?php echo ($observacion['Observacion']['dirplancuidado']); ?>
                                            </td>
