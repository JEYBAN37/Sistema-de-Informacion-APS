...
// Generar los checkboxes y agregarlos al contenedor
    ...
    const opcionesVacunancion = opcionesActividades = [
        '2,3,4,AÑOS	Sarampión Rubeola Paperas (SRP)	Refuerzo',
        '5AÑOS	Difteria -  tosferina - tétanos DPT	Refuerzo',
        '5 AÑOS	Vacuna inactivada de polio - VIP  	Refuerzo',
        '5 AÑOS	VARICELA	Refuerzo',
        '2,3,4,5 AÑOS	Vacuna contra COVID 19 	Refuerzo',
