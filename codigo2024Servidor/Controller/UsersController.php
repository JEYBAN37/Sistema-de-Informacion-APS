...
if ($this->request->is('post')) {
    ...
    public function initDB()
    {
       ...
       $this->Acl->deny($group, 'controllers/Plsmomentos/delete');*/
        ...
        $this->Acl->allow($group, 'controllers/visitasnegadas/delete');
        $this->Acl->allow($group, 'controllers/primerainfancias/add');
        $this->Acl->allow($group, 'controllers/primerainfancias/add2_5');
        $this->Acl->allow($group, 'controllers/primerainfancias/edit');*/
